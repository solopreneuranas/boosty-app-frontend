    ...
    const displayCompaniesList = () => {
        return (
            <div style={{ background: 'white', borderRadius: 10, paddingBottom: '2%' }}>
                <div style={{ width: '95%', margin: '3% 0 2%', padding: '2.5%' }}>
                    <Grid container spacing={1} style={{ width: '100%', margin: 0, borderRadius: 10, display: 'flex', alignItems: 'center' }}>
                        ...
                        <Grid item xs={4} style={{ display: 'flex', alignItems: 'center' }}>
                            <h3 style={{ margin: 0, fontWeight: 600, fontSize: 16 }}>Company Name</h3>
                        </Grid>
                        <Grid item xs={2} style={{ display: 'flex', alignItems: 'center' }}>
                            <h3 style={{ margin: 0, fontWeight: 600, fontSize: 16 }}>State</h3>
                        </Grid>
                        <Grid item xs={2} style={{ display: 'flex', alignItems: 'center' }}>
                            <h3 style={{ margin: 0, fontWeight: 600, fontSize: 16 }}>Owner Name</h3>
                        </Grid>
                        <Grid item xs={1} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                            <h3 style={{ margin: 0, fontWeight: 600, fontSize: 16 }}>Amount</h3>
                        </Grid>
                ...
                </div>
                {
                    companies.map((item, i) => {
                        ...
                        return (
                            <div style={{ width: '100%', padding: '1% 0', borderBottom: '1px solid gainsboro' }}>
                                <Grid onClick={() => handleCompanyClick(item)} container spacing={1} style={{ cursor: "pointer", width: '100%', margin: 0, padding: '1%', background: 'white', display: 'flex', alignItems: 'center' }}>
                                    ...
                                    <Grid item xs={4} style={{ display: 'flex', alignItems: 'center' }}>
                                        <h3 style={{ margin: 0, fontWeight: 500, fontSize: 16 }}>{item.companyname} {item.companytype}</h3>
                                    </Grid>
                                    <Grid item xs={2} style={{ display: 'flex', alignItems: 'center' }}>
                                        <h3 style={{ margin: 0, fontWeight: 500, fontSize: 16 }}>{item.companystate}</h3>
                                    </Grid>
                                    <Grid item xs={2} style={{ display: 'flex', alignItems: 'center' }}>
                                        <h3 style={{ margin: 0, fontWeight: 500, fontSize: 16 }}>{item.userData[0].firstname} {item.userData[0].lastname}</h3>
                                    </Grid>
                                    <Grid item xs={1} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                        <h3 style={{ margin: 0, fontWeight: 500, fontSize: 16 }}>${item.orderamount}</h3>
                                    </Grid>
                                    <Grid item xs={2} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <>
                        <Grid container spacing={1}>
                            <Grid item md={6} style={{ width: '100%' }}>
                                <h3 style={{ margin: 0, fontWeight: 600, fontSize: matches_md ? 22 : 25 }}>All Companies</h3>
